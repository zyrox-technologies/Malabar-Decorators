...
export const menuCategories: MenuCategory[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: "s-4", name: "കൂട്ടുകറി", malayalam: "Kootu Curry", type: "veg" },
      { id: "s-5", name: "അവിയൽ", malayalam: "Aviyal", type: "veg" },
      { id: "s-6", name: "തോരൻ", malayalam: "Thoran", type: "veg" },
      { id: "s-7", name: "കാളൻ", malayalam: "Kurukku Kalan", type: "veg" },
      { id: "s-8", name: "ഓലൻ", malayalam: "Olan", type: "veg" },
      { id: "s-9", name: "പുളിശ്ശേരി", malayalam: "Pulissery / Moru Curry", type: "veg" },
      { id: "s-10", name: "രസം", malayalam: "Traditional Rasam", type: "veg" },
      { id: "s-11", name: "പച്ചടി", malayalam: "Pachadi", type: "veg" },
      { id: "s-12", name: "കിച്ചടി", malayalam: "Kichadi", type: "veg" },
      { id: "s-13", name: "ഇഞ്ചിപ്പുളി", malayalam: "Inji Puli", type: "veg" },
      { id: "s-14", name: "മാങ്ങ അച്ചാർ", malayalam: "Mango Pickle", type: "veg" },
      { id: "s-15", name: "നാരങ്ങ അച്ചാർ", malayalam: "Lime Pickle", type: "veg" },
      { id: "s-16", name: "കായ വറുത്തത്", malayalam: "Banana Chips", type: "veg" },
      { id: "s-17", name: "ശർക്കര വരട്ടി", malayalam: "Sharkara Varatti", type: "veg" },
      { id: "s-18", name: "പപ്പടം", malayalam: "Kerala Crispy Pappadam", type: "veg" },
      { id: "s-19", name: "പഴം", malayalam: "Pazham (Banana)", type: "veg" },
      { id: "s-20", name: "അട പ്രഥമൻ", malayalam: "Ada Pradhaman", type: "veg" },
      { id: "s-21", name: "പാലട പായസം", malayalam: "Palada Payasam", type: "veg" },
      { id: "s-22", name: "സംഭാരം", malayalam: "Spiced Buttermilk Sambharam", type: "veg" },
    ],
  },
];
