export const teamData = {
  ...
  headline: "Dedicated to Memorable Celebrations",
  subheadline:
    "Bringing together experienced event decorators and traditional catering artisans to create unforgettable celebrations in Kasaragod.",
  founder: {
    name: "Malabar Decorators Team",
    role: "Event Decoration & Catering",
    badge: "ESTABLISHED IN 2011",
    ...
    highlights: [
      ...
      { number: "Decor & Food", label: "Complete Service" },
    ],
  },
};
